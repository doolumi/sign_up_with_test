...
void main() {
  group('E-mail Validation Check', () {
    test('@수 2개 이상: ERROR', () {
      Either<EmailValidationFailure, String> result =
  ...
  group('Password 조건 1.영문, 숫자, 특수문자 2가지 이상 8~20자', () {
    test('8자 미만 : ERROR', () {
      Either<Password1ValidationFailure, String> result =
  ...
  group('Password 조건 2. 반복 되거나 동일한 숫자/문자', () {
    test('동일 숫자 : ERROR', () {
      Either<Password2ValidationFailure, String> result =
  ...
  group('이름 체크', () {
    test('한글자 이하 : ERROR', () {
      Either<NameValidationFailure, String> result =
  ...
  group('휴대전화', () {
    test('앞의 고유번호 ex(010) + 7~8글자 : PASS', () {
      Either<PhoneValidationFailure, String> result =
